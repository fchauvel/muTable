...
public class CSVFormat implements Format {
    ...
    public CSVFormat() {
        this(Arrays.asList("csv", "tsv"), new CSVReader(), new CSVWriter());
    } 

    public CSVFormat(List<String> extensions, Reader reader, Writer writer) {
    ...
    @Override
    public Table read(InputStream input, long timeout) throws ReaderException {
        return reader.readFrom(input, timeout);
    }
